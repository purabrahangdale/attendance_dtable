...
const Dashboard = () => {
  ...
  const fetchHistory = useCallback(async () => {
    try {
      const response = await axios.get(`http://attendancedtable-production.up.railway.app/attendance/history?user_id=${email}`);
  ...
  const captureAndPunch = useCallback(async () => {
    ...
    try {
      const response = await axios.post('http://attendancedtable-production.up.railway.app/attendance/punch', {
        user_id: email,
        type: punchType,
        location: {
