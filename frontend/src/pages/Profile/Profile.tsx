...
const Profile = () => {
  ...
  const checkStatus = useCallback(async () => {
    try {
      const res = await axios.get(`https://attendance-dtable-h8bbsnq71-purabrahangdales-projects.vercel.app/attendance/face-status?user_id=${email}`);
  ...
  const handleRegister = async () => {
    ...
    try {
      await axios.post('https://attendance-dtable-h8bbsnq71-purabrahangdales-projects.vercel.app/attendance/register-face', {
        user_id: email,
        image: image
      });
